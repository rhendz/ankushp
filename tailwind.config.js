    ...
    extend: {
      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          ...
          // },
          css: {
            '--tw-prose-body': theme('colors.secondary/0.6'),
            ...
            '--tw-prose-counters': theme('colors.secondary/0.6'),
            '--tw-prose-bullets': theme('colors.secondary/0.6'),
            '--tw-prose-hr': theme('colors.pink[300]'),
            '--tw-prose-quotes': theme('colors.secondary/0.6'),
