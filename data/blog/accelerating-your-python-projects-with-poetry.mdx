...
Let's setup our shell environment for pyenv. Today, we'll use
...
Note, you can use `poetry list` to see all available commands and `poetry <command> --help` to see specific details for a command.
