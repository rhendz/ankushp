...
<Diagram
  src="./foundations-of-quantization/diagram00"
  caption="Illustration of symmetric quantization mapping to restricted range [-127, 127]."
/>

In symmetric quantization, we map the floating-point range $r$ to the quantized range $Q$ with respect to $0$ as shown in Figure 1. To do so, we choose $-\alpha = \beta = \max|x_f|$, where $x_f$ is some number in the floating-point range. Basically,
...
<Diagram
  src="./foundations-of-quantization/diagram01"
  caption="Illustration of asymmetric quantization mapping to range [-128,127]."
/>
