...
const config = dotenvExpand.expand({ parsed: { ...process.env } })
...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.googletagmanager.com https://va.vercel-scripts.com;
 ...
 **/
module.exports = () => {
  // Skip contentlayer during build if files are pre-generated
